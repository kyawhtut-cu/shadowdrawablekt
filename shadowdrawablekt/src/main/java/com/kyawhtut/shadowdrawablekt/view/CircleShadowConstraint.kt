...
import com.kyawhtut.shadowdrawablekt.utils.Extension.circleShadowDrawable
 ...
 * @date 15/09/2020
 */
class CircleShadowConstraint @JvmOverloads constructor(
    context: Context,
    attributeSet: AttributeSet? = null,
    defStyleAttr: Int = 0
) : ConstraintLayout(context, attributeSet, defStyleAttr) {

    private val shape = circleShadowDrawable {
    }
    ...
    init {
        ...
        try {
            ...
            shape.shadowRadius = a.getDimension(R.styleable.ShadowConstraint_shadowRadius, 0f)
